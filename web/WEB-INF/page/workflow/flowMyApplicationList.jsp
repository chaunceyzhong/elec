...
<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/WEB-INF/page/workflow/flowMyApplicationList.jsp" method="post" style="margin:0px;">
								...
								<td width="12%" align="center" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">查看流程记录</td>
									...
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="12%">
											<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/page/workflow/flowApprovedHistory.jsp?applicationID=3"><img src="${pageContext.request.contextPath }/images/button_view.gif" border="0" style="CURSOR:hand"></a>
										</td>
									</tr>
						</table>		
					</td>
