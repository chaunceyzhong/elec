			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="left" bgColor="#f5fafe" colspan="2">			
								...
								<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/page/workflow/flowSubmitApplication.jsp?applicationTemplateID=1">设备购置计划模板</a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
						
								
								<img width="16" height="16" src="${pageContext.request.contextPath }/images/doc.gif"/> 
								<a id="Form2_" href="${pageContext.request.contextPath }/WEB-INF/page/workflow/flowSubmitApplication.jsp?applicationTemplateID=2">设备费用报销模板</a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
