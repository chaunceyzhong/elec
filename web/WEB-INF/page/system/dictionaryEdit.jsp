...
<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
                    ...
                    <s:iterator value="#request.list" var="system">
                        <tr>
                            ...
                            <td class="ta_01" align="center" width="60%">
                                <input id="itemname" name="itemname" type="text" value="<s:property value="#system.ddlName"/>" size="45"
                                       maxlength="25"></td>
    ...
    <tr>
        <td align="center" colspan=3>
            <input type="button" name="saveitem" value="保存"
                   style="font-size:12px; color:black; height:20px;width:50px" onClick="saveDict()">
        </td>
    </tr>
