...
<Script language="javascript">
 ...
 <br>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.sexList"  name="sexID" id="sexID" listValue="ddlName" listKey="ddlCode" cssStyle="width:155px"/>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">职位：<font color="#FF0000">*</font></td>
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.postList"  name="postID" id="postID" listValue="ddlName" listKey="ddlCode" cssStyle="width:155px"/>
		</td>
	</tr>
	<tr>
