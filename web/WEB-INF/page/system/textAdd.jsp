	...
	<table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				<s:textarea name="textName" id="textName" cssStyle="width: 500px; height: 160px; padding: 1px;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('textName');"></s:textarea>
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				<s:textarea name="textRemark" id="textRemark" cssStyle="width: 500px; height: 160px; padding: 1px;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('textRemark');"></s:textarea>
			</td>
